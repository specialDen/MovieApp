...
class SearchViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    presenter?.collectionManager?.setUpTableView(tableView: tableView, for: contentType!)
  ...
  @objc private func didSelectMovies() {
    ...
    presenter?.collectionManager?.updateContentType(with: contentType!)
    presenter?.viewNeedsMovies()
  }
